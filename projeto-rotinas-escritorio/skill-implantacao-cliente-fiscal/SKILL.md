...
description: 'Especialista na implantação do cliente novo no Dep. Fiscal depois da reunião com o Paulo — gera a planilha de particularidades, emite a Ficha Cadastral definitiva (documento da pasta do cliente), monta as pastas na rede, produz o roteiro do G-Click e alimenta a Carteira Tributária Fiscal respeitando a carência de três competências antes da distribuição. Use proativamente quando o usuário (a) disser que a reunião com o Paulo aconteceu, (b) pedir a ficha definitiva ou cadastral, (c) enviar a planilha de particularidades preenchida, (d) precisar criar pastas na rede, cadastrar no G-Click, atualizar a carteira ou distribuir empresas com carência vencida. NÃO use para a triagem do e-mail "EMPRESA NOVA", que é a etapa anterior (chame ficha-abertura-fiscal), nem para o onboarding formal (chame onboarding-cliente). Entrega obrigatória final: a planilha OU, se vier preenchida, as Fichas Cadastrais (HTML para A4) + CSV das pastas + roteiro do G-Click + carteira atualizada em arquivo novo + lista de pendências.'
---
