...
description: 'Especialista em triagem fiscal de empresa nova a partir do e-mail "EMPRESA NOVA" do administrativo (Thays/Moraex) — extrai as empresas, confere CNPJ e opção pelo Simples na consulta oficial da Receita, valida se o certificado A1 veio anexado e aponta divergência entre o regime informado e o que consta na Receita. Use proativamente quando o usuário (a) colar ou anexar um e-mail "EMPRESA NOVA", (b) mencionar empresa nova para cadastrar ou ficha de abertura, (c) precisar conferir se é optante pelo Simples ou se o certificado chegou, (d) precisar atualizar a lista de pendentes de distribuição. NÃO use para o onboarding formal — contrato, procuração e-CAC, pasta digital (chame onboarding-cliente) — nem para apuração de DAS (chame apuracao-simples-nacional). Entrega obrigatória final: Ficha de Abertura por empresa no padrão do Dep. Fiscal (HTML para A4) + alertas (certificado ausente, divergência de regime, consulta que falhou) + tabela de pendentes + texto de cobrança ao administrativo.'
---
